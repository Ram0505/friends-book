...
<body>
	<table>
		...
		<tr>
			<td
				style="color: red; font-size: 100px; text-align: left; position: absolute; left: 40px; top: 92px;"><h1>Hi
					${firstname}, Welcome To FriendsBook.</h1> <br /></td>
	...
	<section>
	<div style="position: relative; top: 203px;">
		<div class="container-fluid"
